...
export default function MembershipContent() {
    ...
    return (
      <div className="mx-auto max-w-4xl">
        <div className="animate-pulse space-y-8">
          <div className="h-12 bg-black/5 rounded w-64 mx-auto" />
          <div className="h-6 bg-black/5 rounded w-96 mx-auto" />
  ...
  // Paid member — show confirmation instead of pricing
  if (isPaid) {
    return (
      <>
        <div className="mx-auto max-w-2xl text-center mb-16">
          ...
          >
            Du hast vollen Zugang zu allen Deep Dives, exklusiven Analysen und
            dem Premium-Newsletter.
          </p>
        </div>

        <div className="mx-auto max-w-md">
          <div className="bg-white/60 backdrop-blur-xl rounded-2xl border border-[#6C5CE7]/20 p-10 text-center">
            <div className="w-16 h-16 rounded-full bg-[#6C5CE7]/10 flex items-center justify-center mx-auto mb-6">
              <svg
                width="32"
                height="32"
                viewBox="0 0 24 24"
            ...
            <div className="space-y-3">
              <Link
                href="/account"
                className="inline-flex items-center justify-center w-full py-3 px-8 rounded-full bg-[#6C5CE7] text-white font-medium text-sm hover:bg-[#5A4BD1] transition-colors"
              >
                Mein Konto
              </Link>
              <Link
  ...
  // Free or not logged in — show pricing
  return (
    <>
      <div className="mx-auto max-w-2xl text-center mb-16">
        <h1
